...
<head>
    <title>雷科-LASER(雷射)設備 PCB/FPC產業 Under-fill remove</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, 雷射部門, laser, 被動元件產業, Laser Trimmer,PCB Under-fill remove, " />
    <meta name="description" content="雷科-LASER(雷射)設備 PCB/FPC產業 Under-fill remove" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-PCB/FPC產業 Under-fill remove</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_lmc10_az3100.php"> • 單頭鐳射條碼雕刻機/LM-C10-MZ70</option>
                                        ...
                                        <ul class="product_menu_select ">
                                            <li class="custom-select">
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_pcb_under-fill_remove.php" selected="true"> • Under-fill remove</option>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film09.png" alt="Under-fill remove">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    ...
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_pcb_laser_routing.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_pcb.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_pcb_pcb_laser_cutting.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>Under-fill remove</h5>
                                <p>雷射除膠機</p>
                            </div>
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">降低人工作業良率及工時損耗。</li>
                                <li class="ltt_page_text_li_samp">簡易的圖形化操作畫面，易上手。</li>
                                <li class="ltt_page_text_li_samp">加入測高sensor判斷，除膠平整度佳。</li>
                                <li class="ltt_page_text_li_samp">可允許數次加工，多次測高除膠。</li>
                            </ul>

                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【雷射種類】</span>
                                    <span class="ltt_page_text_color">CO2 laser</span>
                                </li>
                            </ul>
                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【產品用途】</span>
                                    <span class="ltt_page_text_color">雷射除膠機 for BGA rework underfill</span>
                                </li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film09.png">
                        <samp class="product_features_type">FPCB Laser Routing</samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film09_01.png">
                        <samp class="product_features_type">成品</samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film09_02.png">
                        <samp class="product_features_type">成品</samp>
                    </div>
                </div>
