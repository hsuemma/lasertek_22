...
(function(fn) {
    ...
    var getAttributes = function() {
        ...
        if (!langData) {
            data = {
                'text': '本網站訂有隱私權政策以保護您個人於本網站的隱私權，請點【我接受】代表您同意本網站隱私權政策，請點選雷科(股)公司網站',
                'accept_text': '我接受',
                'more_text': '隱私權政策。',
                'more_link': '../lasertek/company_privacy_policy.php',
                //'reject_text': '我拒絕',
                //'reject_info': '您可以使用此程序禁用不需要的cookie',
    ...
    var warn = function() {
        ...
        if (attributes.data.reject_text) {
            ...
            reject_content = '<span class="reject_more">' + attributes.data.reject_info + ' <a href="' + attributes.data.reject_link + '">' + attributes.data.reject_link + '</a></span>';
        } else {
            reject_button = '';
            reject_content = '';
        }
