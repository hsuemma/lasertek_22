...
<head>
    <title>雷科-LASER(雷射)設備 Laser marking</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,半導體產業 Laser marking Laser marking, " />
    <meta name="description" content="雷科-LASER(雷射)設備 Laser marking" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備 Laser marking</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_semiconductor_laser_marking.php" selected="true"> • Laser marking</option>
                                                </select>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film14.png" alt="Laser marking">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    ...
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_semiconductor_Wafe_laser.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_semiconductor.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_opto_tf3000.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            ...
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">可適用於IC、PCB及Ceramic材料。</li>
                                <li class="ltt_page_text_li_samp">可進行一維 / 二維條碼、及任意雷射刻印。</li>
                                <li class="ltt_page_text_li_samp">雙頭雷射設計，提升產能。</li>
                                <li class="ltt_page_text_li_samp">自動上下料，減省生產工時。</li>
                            </ul>
                            ...
                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【產品用途】</span>
                                    <span class="ltt_page_text_color">Laser marking</span>
                                </li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film14.png" alt="Laser marking">
