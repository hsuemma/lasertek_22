...
<head>
    <title>雷科-LASER(雷射)設備 Laser Trimmer-Thick Film Trimmer TF-2010G</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Thick Film Trimmer,TF-2010G, " />
    <meta name="description" content="雷科-LASER(雷射)設備 Laser Trimmer-Thick Film Trimmer TF-2010G" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Trimmer-Thick Film Trimmer TF-2010G</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_tf2010g.php" selected="true"> • TF-2010G</option>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film01.png" alt="TF-2010G">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <a aria-label="下載" data-balloon-pos=" up" href="download/laser/TF-2010G S2.pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>
                                    ...
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_trimmer_tf3050_s3.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>TF-2010G</h5>
                                <p>Series 2 Y70 Laser Trimmer</p>
                            </div>
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">可以涵蓋至01005全尺寸的電阻。</li>
                            ...
                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【雷射種類】</span>
                                    <span class="ltt_page_text_color">Diode pumped Q-switched Nd: YAG laser(532nm)</span>
                                </li>
                            </ul>
                            <ul class="ltt_page_text">
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film01.png">
                        <samp class="product_features_type">TF-2010G</samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
