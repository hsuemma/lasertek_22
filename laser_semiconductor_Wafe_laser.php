...
<head>
    <title>雷科-LASER(雷射)設備 半導體產業Laser marking-Wafer Laser marking</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,半導體產業 Laser marking Wafer Laser marking, " />
    <meta name="description" content="雷科-LASER(雷射)設備 半導體產業Laser marking-Wafer Laser marking" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-半導體產業Laser marking Wafer Laser marking</h1>
    ...
    <main class="cd-main-content">
        ...
        <div class="ltt_container_img">
            ...
            <section class="ltt_news_all02">
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_semiconductor_Wafe_laser.php" selected="true"> • Wafer Laser marking</option>
                ...
                <h3 av-animation="fadeInDown">半導體產業</h3>
                <h4 av-animation="fadeInUp">Laser marking</h4>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film13.png" alt="Wafer Laser marking">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    ...
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_lm_c10_az3100.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_semiconductor.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_semiconductor_laser_marking.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>Wafer Laser marking</h5>
                                <p>Wafer laser marking</p>
                            </div>
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">雕刻後無飛濺。</li>
                                <li class="ltt_page_text_li_samp">Stack to Stack mode or Cassette to Cassette mode。</li>
                                <li class="ltt_page_text_li_samp">符合製程所需之無塵等級。</li>
                                <li class="ltt_page_text_li_samp">自動上下料，減省生產工時，上下料方式可依客製化設計。</li>
                            </ul>
                            ...
                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【產品用途】</span>
                                    <span class="ltt_page_text_color">Wafer laser marking</span>
                                </li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film13.png" alt="Wafer Laser marking">
                        <samp class="product_features_type">Wafer Laser marking </samp>
                    </div>
