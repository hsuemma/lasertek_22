...
<head>
    <title>雷科-LASER(雷射)設備 Laser Trimmer-Thin Film Trimmer 雷射半自動雕刻機/LM1000</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Thin Film Trimmer,雷射半自動雕刻機/LM1000" />
    <meta name="description" content="雷科-LASER(雷射)設備 Laser Trimmer-Thin Film Trimmer 雷射半自動雕刻機/LM1000" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Trimmer-Thin Film Trimmer 雷射半自動雕刻機/LM1000</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_lm1000.php" selected="true"> • 雷射半自動雕刻機/LM1000</option>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film19.png" alt="雷射半自動雕刻機/LM1000">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <a aria-label="下載" data-balloon-pos="up" href="download/laser/雷射半自動雕刻機LM1000(Basic).pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_trimmer_lmc10_az3100.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_trimmer_thin_film.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_trimmer_lmc10_az200.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            ...
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">自動兩段式定位。</samp></li>
                                <li class="ltt_page_text_li_samp">雕刻循環自動控制。</samp></li>
                                <li class="ltt_page_text_li_samp">動模擬操作。</samp></li>
                            ...
                            <ul class="ltt_page_text">
                                ...
                                <li><span class="ltt_page_text_span">【產品型號】</span>
                                    <span class="ltt_page_text_color">LM1000。</span>
                                </li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all ">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film19.png" alt="雷射半自動雕刻機/LM1000">
                        <samp class="product_features_type">雷射半自動雕刻機/LM1000</samp>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <p>半自動雷射雕刻模組
                                        <p>
                                            <li>雷射光源，雷射形式：Pulsed Fiber Laser(光穩定度+-1%)</li>
                                            <li>功率@30kHz：20W，波長：1064nm</li>
                                            <li>最小脈衝寬度＜15ns，最大峰值功率＞3mj</li>
                                            <li>光斑品質（㎡）＜1.6，頻率:1-100K Hz</li>
                                            <li>冷卻方面:氣冷式振鏡</li>
                                            <li>雕刻範圍：150mm x 150mm(標準型)</li>
                                    </ul>
                                </td>
                                <td>1</td>
                                <td>Incl.</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <p>中文版雕刻軟體
                                        <p>
                                            <li>支援DXF、PLT、BMP、JPG 等檔案格式</li>
                                            <li>可自動序號、可標示一、二維條碼</li>
                                            <li>具自動化生產升級功能</li>
                                            <li>Barcode reader for code 128</li>
                                    </ul>
                                </td>
                                <td>1</td>
                                <td>Incl.</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <p>Tray 盤定位模組
                                        <p>
                                            <li>功能：負責Tray 盤自動在上下料位置及雕刻位置間移動</li>
                                            <li>有效行程 : 標準400mm(可客製化製造)</li>
                                            <li>位置重現精度:±0.1mm</li>
                                            <li>移動速度 MAX 15m/min</li>
                                            <li>最大承載重量 10kg</li>
                                            <li>機器重量 450kg(Approx.)</li>
                                            <li>最小設定單位 0.001mm</li>
                                            <li>驅動傳動方式 精密螺桿驅動線性平台</li>
                                            <li>Marking 控制：PC Based Control</li>
                                    </ul>
                                </td>
                                <td>1</td>
                                <td>Incl.</td>
