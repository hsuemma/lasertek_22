...
<head>
    <title>雷科-LASER(雷射)設備 光電產業 LED Laser Drill / Scribing</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,光電產業 LED Laser Drill / Scribing, " />
    <meta name="description" content="雷科-LASER(雷射)設備 光電產業 LED Laser Drill / Scribing" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-光電產業 LED Laser Drill / Scribing</h1>
            ...
            <section class="ltt_news_all02">
                ...
                <div id="breadcrumbs">
                    <ul>
                        ...
                        <li><a href="laser_opto.php">光電產業 LED substrate drilling</a> > </li>
                        <li>LED Laser Drill / Scribing</li>
                    </ul>
                </div>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                ...
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_opto_drill_scribing.php" selected="true"> • LED Laser Drill/Scribing</option>
                                                </select>
                ...
                <h3 av-animation="fadeInDown">光電產業</h3>
                <h4 av-animation="fadeInUp">LED substrate drilling </h4>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film16.png" alt="LED Laser Drill/Scribing">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <!--<a href="download/laser/AS-0201_50W.pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>-->
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_opto_tf3000.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_opto.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <!--<a href="laser_opto_drill_scribing.php" class="ltt_page_down_next" title="下一個"></a>-->
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>LED Laser Drill/Scribing</h5>
                                <p>LED Laser Drill/Scribing</p>
                            </div>
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">全球速度最快。</li>
                                <li class="ltt_page_text_li_samp">適用於ALN及AL2O3的基板。/li>
                                <li class="ltt_page_text_li_samp">速度快，準確度高，斷面美觀。</li>
                                <li class="ltt_page_text_li_samp">具備Scribing / Drilling / cutting 3 種功能。</li>

                            </ul>

                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【雷射種類】</span>
                                    <span class="ltt_page_text_color">IR Laser</span>
                                </li>
                            </ul>

                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【產品用途】</span>
                                    <span class="ltt_page_text_color">散熱機板加工</span>
                                </li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film16.png" alt="LED Laser Drill / Scribing">
                        <samp class="product_features_type">LED Laser Drill / Scribing</samp>
                    </div>

                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film16_01.png" alt="LED Laser Drill / Scribing">
                        <samp class="product_features_type">成品</samp>
                    </div>

                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film16_02.png" alt="LED Laser Drill / Scribing">
                        <samp class="product_features_type">成品</samp>
                    </div>
