...
<head>
    <title>雷科-LASER(雷射)設備 Laser Trimmer Thin Film Trimmer - TF-3050G S3</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Thin Film Trimmer,TF-3050G S3, " />
    <meta name="description" content="雷科-LASER(雷射)設備 TF-3050G S3" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Trimmer-Thin Film Trimmer TF-3050G S3</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_tf3050g_s3.php" selected="true"> • TF-3050G S3</option>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <!--<a href="download/laser/TF-3050 S3.pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>-->
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_trimmer_tf8000.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_trimmer_thin_film.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_trimmer_tf3050g_s2.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>TF-3050G S3</h5>
                                <p>Thin-film Laser Trimmer TF-3050G S3</p>
                            </div>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        ...
                        <samp class="product_features_type">TF-3050G S3</samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
