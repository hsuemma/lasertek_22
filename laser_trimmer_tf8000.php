...
<head>
    <title>雷科-LASER(雷射)設備 Thick Film Trimmer Embedded Resistor Laser Trimmer/TF-8000</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Thick Film Trimmer,Embedded Resistor Laser Trimmer/TF-8000" />
    <meta name="description" content="雷科-LASER(雷射)設備 Thick Film Trimmer Embedded Resistor Laser Trimmer/TF-8000" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Trimmer-Thick Film Trimmer Embedded Resistor Laser Trimmer/TF-8000</h1>
            ...
            <section class="ltt_news_all02">
                ...
                <div id="breadcrumbs">
                    <ul>
                        ...
                        <li><a href="laser_trimmer_thick_film.php">被動元件產業 Thick Film Trimmer</a> > </li>
...
<div class="product_menu">
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_lr400.php"> • 單頭鑽孔機/LR-400</option>
                                                    <option value="laser_trimmer_ls1070c430.php"> • 光纖雷射切割機/LS-1070C-430</option>
                                                    <option value="laser_trimmer_tf8000.php" selected="true"> • Embedded Resistor Laser Trimmer TF-8000</option>
                ...
                <h4 av-animation="fadeInUp">Laser Trimmer-Thick Film Trimmer</h4>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film26.png" alt="Embedded Resistor Laser Trimmer/TF-8000">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    ...
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_trimmer_ls1070c430.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_trimmer_thick_film.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_trimmer_tf3050g_s3.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all ">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film26.png" alt="Embedded Resistor Laser Trimmer/TF-8000">
