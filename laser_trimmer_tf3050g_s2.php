...
<head>
    <title>LASER(雷射)設備 Laser Trimmer-Thin Film Trimmer TF-3050G S2</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Thin Film Trimmer,TF-3050G S2, " />
    <meta name="description" content="雷科-LASER(雷射)設備 Laser Trimmer-Thin Film Trimmer TF-3050 S2" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Trimmer-Thin Film Trimmer TF-3050G S2</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_tf3050g_s2.php" selected="true"> • TF-3050G S2</option>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film03.png" alt="TF-3050G S2">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <a aria-label="下載" data-balloon-pos="up" href="download/laser/TF-3050G S2.pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_trimmer_tf3050g_s3.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_trimmer_thin_film.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_trimmer_lmc10_az3200.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>TF-3050G S2</h5>
                                <p>Thin-film Laser Trimmer TF-3050G S2</p>
                            </div>
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">可以涵蓋至0402全尺寸的電阻。</li>
                                <li class="ltt_page_text_li_samp">可以涵蓋自ｍΩ至MΩ的量測範圍。</li>
                                <li class="ltt_page_text_li_samp">可以涵蓋的基板大小為50mmX60mm及60mmX70mm。</li>
                            ...
                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【雷射種類】</span>
                                    <span class="ltt_page_text_color">Diode pumped Q-switched (532nm)</span>
                                </li>
                            </ul>
                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【產品用途】</span>
                                    <span class="ltt_page_text_color">Thin-film R-SMD Laser Trimmer</span>
                                </li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        ...
                        <samp class="product_features_type">TF-3050G S2</samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film04_01.png">
