...
<head>
    <title>LASER(雷射)設備 光電產業 LED substrate drilling </title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 鐳射機銷售, 設備專業保養維護, 設計各項鐳射運用設備, 被動元件產業, PCB/FPC產業, 半導體產業, 光電產業,光電產業LED substrate drilling , " />
    <meta name="description" content="LASER(雷射)設備 光電產業 LED substrate drilling" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備 光電產業 LED substrate drilling </h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                ...
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_opto.php" selected="true">LED substrate drilling ALL</option>
                ...
                <div class="ltt_box_content_all">
                    ...
                    <div class="wow slideInRight ltt_box_product_33 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <a href="laser_opto_tf3000.php"><img class="ltt_box_product_img" src="img/laser/product_thick_film15.png" alt="TF-3000 LED測試包裝機"></a>
                            <p><a href="laser_opto_tf3000.php">TF-3000 LED測試包裝機</a></p>
                        </div>
                    ...
                    <div class="wow slideInLeft ltt_box_product_33 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <a href="laser_opto_drill_scribing.php"><img class="ltt_box_product_img" src="img/laser/product_thick_film16.png" alt="LED Laser Drill / Scribing"></a>
                            <p><a href="laser_opto_drill_scribing.php">LED Laser Drill / Scribing</a></p>
                        </div>
                        <p class="ltt_box_product_description">
                            速度快，準確度高，斷面美觀
                        </p>
