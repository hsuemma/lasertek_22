...
<head>
    <title>雷科-LASER(雷射)設備 Laser Trimmer-Thin Film Trimmer 光纖雷射切割機/LS-1070C-430</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Thin Film Trimmer,光纖雷射切割機/LS-1070C-430" />
    <meta name="description" content="雷科-LASER(雷射)設備 Laser Trimmer-Thin Film Trimmer 光纖雷射切割機/LS-1070C-430" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Trimmer-Thin Film Trimmer 光纖雷射切割機/LS-1070C-430</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_ls_1070c430.php" selected="true"> • 光纖雷射切割機/LS-1070C-430</option>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    ...
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_trimmer_lr_400.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_trimmer_thin_film.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_trimmer_ls_600355400.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
