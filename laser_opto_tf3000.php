...
<head>
    <title>雷科-LASER(雷射)設備 光電產業  TF-3000 LED測試包裝機</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,光電產業 TF-3000 LED測試包裝機, " />
    <meta name="description" content="雷科-LASER(雷射)設備 光電產業 TF-3000 LED測試包裝機" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-光電產業 TF-3000 LED測試包裝機</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_tf8000.php"> • Embeddedr Resistor Laser Trimmer TF-8000</option>
                                                    ...
                                                    <option value="laser_trimmer_embedded_resistor.php" class="product_menu_select_class"><smap>Embedded Resistor Laser Trimmer ALL</smap></option>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                ...
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_opto_tf3000.php" selected="true"> • TF-3000 LED測試包裝機</option>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film15.png" alt="TF-3000 LED測試包裝機">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    ...
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_semiconductor_laser_marking.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_opto.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_opto_drill_scribing.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>TF-3000 LED測試包裝機</h5>
                                <p>測試包裝機</p>
                            </div>
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">速度可超過1000 pcs/min。</li>
                                <li class="ltt_page_text_li_samp">特殊轉盤設計，無夾傷風險。</li>
                                <li class="ltt_page_text_li_samp">更換Type程序簡單。</li>
                                <li class="ltt_page_text_li_samp">適用LED Chip SIZE：3020，3014，1206，0805，0603，0402。</li>
                                <li class="ltt_page_text_li_samp">適用材料：8mm Carrier tape or emboss Tape。</li>
                            </ul>

                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【產品用途】</span>
                                    <span class="ltt_page_text_color">自動化測試包裝設備</span>
                                </li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film15.png" alt="TF-3000 LED測試包裝機">
                        <samp class="product_features_type">TF-3000 LED測試包裝機</samp>
                    </div>

                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film15_01.png" alt="TF-3000 LED測試包裝機">
                        <samp class="product_features_type">TF-3000 LED測試包裝機</samp>
                    </div>
