...
<head>
    <title>雷科-LASER(雷射)設備 Laser Scribing-離線式自動化條碼噴印機/LM-AI200</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Laser Scribing,離線式自動化條碼噴印機/LM-AI200" />
    <meta name="description" content="雷科-LASER(雷射)設備 Laser Scribing-離線式自動化條碼噴印機/LM-AI200" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Scribing 離線式自動化條碼噴印機/LM-AI200</h1>
            ...
            <section class="ltt_news_all02">
                ...
                <div id="breadcrumbs">
                    <ul>
                        ...
                        <li><a href="laser_scribing.php">被動元件產業 Laser Scribing</a> > </li>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_ls_cot100.ph"> • FR4-PCB CO2雷射切割機/LS-COT100</option>
                                                    ...
                                                    <option value="laser_scribing_ls_1070c430.php"> • 光纖雷射切割機/LS-355-600 & LS-355-400</option>
                                                    <option value="laser_scribing_lm_ai200.php" selected="true"> • 離線式自動化條碼噴印機/LM-AI200</option>
                                    ...
                                    <div class="product_select100">
                                        <ul class="product_menu_select">
                                            <li>
                                                ...
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    <option value="#" selected="true">選擇產品</option>
                                                    <option value="laser_opto.php">LED substrate drilling ALL</option>
                ...
                <h4 av-animation="fadeInUp">Laser Scribing</h4>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film27.png" alt="離線式自動化條碼噴印機/LM-AI200">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <a aria-label="下載" data-balloon-pos="up" href="download/laser/Off-Line Automated Inkjet Printing System_LM-AI200.pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_scribing_ls_1070c430.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_scribing.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_trimmer_tf_8000.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all ">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/smt/product_thick_film27.png" alt="離線式自動化條碼噴印機/LM-AI200">
