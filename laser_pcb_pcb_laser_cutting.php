...
<head>
    <title>雷科-LASER(雷射)設備 PCB/FPC產業 PCB Laser cutting</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer, PCB,PCB Laser cutting, " />
    <meta name="description" content="雷科-LASER(雷射)設備 PCB/FPC產業 PCB Laser cutting" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-PCB/FPC產業 PCB Laser cutting</h1>
            ...
            <section class="ltt_news_all02">
                ...
                <div id="breadcrumbs">
                    <ul>
                        ...
                        <li><a href="#">部門資訊</a> > </li>
                        <li><a href="laser.php">雷射部門</a> > </li>
                        <li><a href="laser_pcb_fpcb.php">PCB / FPC產業 PCB</a> > </li>
                        <li>PCB Laser cutting</li>
                    </ul>
                </div>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_embedded_resistor.php" calss="product_menu_select_class"><samp>Embedded Resistor Laser Trimmer ALL</samp></option>
                                        ...
                                        <ul class="product_menu_select ">
                                            <li class="custom-select">
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_pcb_pcb_laser_cutting.php" selected="true"> • PCB Laser cutting</option>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film10.png" alt="PCB Laser cutting">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    ...
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_pcb_under-fill_remove.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_pcb.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_pcb_stencil_laser_cutting.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>PCB Laser cutting</h5>
                                <p>FR4 PCB硬板切割成型機</p>
                            </div>
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">解決傳統Router刀模切割的準確與空間限制。</li>
                                <li class="ltt_page_text_li_samp">使用彈性，可針對各種不同形狀的PCB外型精密加工。</li>
                                <li class="ltt_page_text_li_samp">可應用於Apple iPhone。</li>
                                <li class="ltt_page_text_li_samp">高精度的加工提升產品材料比。</li>
                            </ul>
                            ...
                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【產品用途】</span>
                                    <span class="ltt_page_text_color">SMT後成品之PCB外廓切割成型</span>
                                </li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film10.png">
                        <samp class="product_features_type">FPCB Laser Routing</samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film10_01.png">
