...
<head>
    <title>雷科-LASER(雷射)設備 Laser Trimmer-Functional Trimmer TF-5900</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Functional Trimmer,TF-5900, " />
    <meta name="description" content="雷科-LASER(雷射)設備 Laser Trimmer-Functional Trimmer TF-5900" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備-Laser Trimmer-Functional Trimmer TF-5900</h1>
            ...
            <section class="ltt_news_all02">
                ...
                <div id="breadcrumbs">
                    <ul>
                        ...
                        <li><a href="laser_trimmer_functional.php">被動元件產業 Functional Trimmer</a> > </li>
                        <li>TF-5900</li>
                    </ul>
                </div>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_trimmer_lm1000.ph"> • 雷射半自動雕刻機/LM1000</option>
                                                    ...
                                                    <option value="laser_trimmer_tf5900.php" selected="true"> • TF-5900</option>
                ...
                <h4 av-animation="fadeInUp">Laser Trimmer-Functional Trimmer</h4>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film05.png" alt="TF-5900">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <a aria-label="下載" data-balloon-pos="up" href="download/laser/TF-5900A.pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_trimmer_tf3050g_s2.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_trimmer_functional.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_scribing_as01005uv.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            <div class="ltt_page_color">
                                <h5>TF-5900</h5>
                                <p>Functional Trimmer TF-5900</p>
                            </div>
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">可以涵蓋至最大5”x5”的尺寸。</li>
                                <li class="ltt_page_text_li_samp">可以涵蓋自ｍΩ至MΩ的量測範圍。</li>
                                <li class="ltt_page_text_li_samp">精準與快速的達到量測需求。</li>
                                <li class="ltt_page_text_li_samp">友善的圖形化操作介面設計。</li>
                            ...
                            <ul class="ltt_page_text">
                                <li><span class="ltt_page_text_span">【產品用途】</span>
                                    <span class="ltt_page_text_color">可應用於P.S.U.;DRAM;Touch PAD;Automobile.</span>
                                </li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film05.png">
                        <samp class="product_features_type">TF-5900</samp>
                    </div>
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film05_01.png">
                ...
                <div class="wow slideInDown ltt_page_down_all_up">
                    <div id="ltt_page_down_up">
                        <a href="download/laser/TF-5900A.pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>
                        <a href="laser_trimmer_tf3050g_s2.php" class="ltt_page_down_last" title="上一個"></a>
                        <a href="laser_trimmer_functional.php" class="ltt_page_down_contents" title="回到目錄"></a>
                        <a href="laser_scribing_as01005uv.php" class="ltt_page_down_next" title="下一個"></a>
                    </div>
                </div>
