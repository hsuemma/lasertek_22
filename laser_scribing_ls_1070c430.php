...
<head>
    <title>雷科-LASER(雷射)設備 Laser Scribing-光纖雷射切割機/LS-1070C-430</title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 被動元件產業, Laser Trimmer,Laser Scribing,光纖雷射切割機/LS-1070C-430" />
    <meta name="description" content="雷科-LASER(雷射)設備 Laser Scribing-光纖雷射切割機/LS-1070C-430" />
...
<body class="nav-is-fixed">
    ...
    <h1>量測SEMI/PCB 雷射設備 光纖雷射切割機/LS-1070C-430</h1>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value="laser_scribing_ls_1070c430.php" selected="true"> • 光纖雷射切割機/LS-355-600 & LS-355-400</option>
                ...
                <div class="ltt_box_content_all">
                    <div class="wow slideInLeft ltt_box_product_50 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <img class="ltt_box_product_img" src="img/laser/product_thick_film23.png" alt="光纖雷射切割機/LS-1070C-430">
                        </div>
                        ...
                        <div class="ltt_box_product_directions">
                            <div class="wow slideInDown ltt_page_down_all">
                                <div id="ltt_page_down">
                                    <!--<a href="download/smt/Laser Drilling  LR-400 Datasheet.pdf" class="ltt_page_down_download" title="檔案下載" target="_blank"></a>-->
                                    <a aria-label="上一個" data-balloon-pos="up" href="laser_scribing_lr_400.php" class="ltt_page_down_last" title="上一個"></a>
                                    <a aria-label="回目錄" data-balloon-pos="up" href="laser_scribing.php" class="ltt_page_down_contents" title="回到目錄"></a>
                                    <a aria-label="下一個" data-balloon-pos="up" href="laser_scribing_lm_ai200.php" class="ltt_page_down_next" title="下一個"></a>
                                </div>
                            </div>
                            ...
                            <ul class="ltt_page_text">
                                <li class="ltt_page_text_li_samp">使用高功率鐳射透電腦控制，人性化介面。</samp></li>
                                <li class="ltt_page_text_li_samp">英國SPI光纖鐳射器 50W，短波長較無熱效應。</samp></li>
                                <li class="ltt_page_text_li_samp">塗佈在20M長光纖表面，出光穩定度高。</samp></li>
                                <li class="ltt_page_text_li_samp">可通過輔助軟件編寫任意形狀切割路徑。</samp></li>
                            </ul>
            ...
            <section class="ltt_smt_map_all">
                ...
                <div class="ltt_box_content_all ">
                    <div class="wow slideInUp ltt_box_product_25 ltt_box_product_right product_features_tetx">
                        <img class="product_features_tetx_img" src="img/laser/product_thick_film23.png" alt="光纖雷射切割機">
                        <samp class="product_features_type">光纖雷射切割機</samp>
                    </div>
